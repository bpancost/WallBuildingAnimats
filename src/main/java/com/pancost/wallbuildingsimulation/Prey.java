...
public class Prey extends SimplePortrayal2D implements Steppable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1303998609569336057L;
	...
	private LinkedList lastFourMoves = new LinkedList();
	...
	private boolean isFrustrated(){
		if(lastFourMoves.size() == 4){
			Object move1 = lastFourMoves.get(3);
			Object move2 = lastFourMoves.get(2);
			Object move3 = lastFourMoves.get(1);
			Object move4 = lastFourMoves.get(0);
