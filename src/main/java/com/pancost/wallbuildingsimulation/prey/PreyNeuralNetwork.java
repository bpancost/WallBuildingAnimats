...
/**
 * The neural network object for the prey creatures.
 * 
 * M is mating neuron
 * H is hunger neuron
...
public class PreyNeuralNetwork {
    ...
    /**
     * Creates a new default implementation of the neural network.
     */
    ...
    /**
     * Creates a neural network where the weights are assigned via a byte array.
     * @param nnDirectEncoding A byte array of weights.
     */
